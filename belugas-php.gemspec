...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Cejas", "Mayra"]
  spec.email         = ["weare@icalialabs.com"]

  spec.summary       = %q{A Ruby CLI for PHP feature detection}
  spec.description   = %q{A Ruby CLI for PHP feature detection using awesome Belugas}
